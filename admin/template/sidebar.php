          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="index.php?page=barang"><i class="fa fa-child" aria-hidden="true"></i>Pakaian</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                      <li><a  href="index.php?page=laporan"><i class="fa fa-file" aria-hidden="true"></i>Laporan Detail Penjualan</a></li>
                      <li><a  href="index.php?page=laporanpj"><i class="fa fa-file" aria-hidden="true"></i>Laporan Penjualan</a></li>
