								...
								?>
									<tr>
										...
										<td>
											<?php if($isi['stok'] <=  '3'){?>
												<form method="POST" action="fungsi/edit/edit.php?stok=edit">
													...
													<a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>" 
														onclick="javascript:return confirm('Hapus Data Pakaian ?');">
											...
											<a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>" onclick="javascript:return confirm('Hapus Data Pakaian ?');"><button class="btn btn-danger btn-xs">Hapus</button></a>
											<?php }?>
								...
								<form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
									<div class="modal-body">
										...
										<table class="table table-striped bordered">
											...
											<tr>
												<td>Ukuran</td>
												<td><input type="text" placeholder="Ukuran" required class="form-control" name="ukuran"></td>
											</tr>
											<tr>
												<td>Warna Barang</td>
