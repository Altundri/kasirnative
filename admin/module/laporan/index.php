                  ...
                  <div class="col-lg-12 main-chart">
						<h3>
							...
							<?php if(!empty($_GET['cari'])){ ?>
								Data Detail Laporan Penjualan <?= $bulan_tes[$_POST['bln']];?> <?= $_POST['thn'];?>
							<?php }elseif(!empty($_GET['hari'])){?>
								Data Detail Laporan Penjualan <?= $_POST['hari'];?>
							<?php }else{?>
								Data Detail Laporan Penjualan <?= $bulan_tes[date('m')];?> <?= date('Y');?>
							<?php }?>
						</h3>
						<br/>
